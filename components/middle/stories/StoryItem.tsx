...
export default function StoryItem({ data }: { data: storyType }) {
  ...
  return (
    <div
      className="p-3 rounded-2xl flex flex-col justify-between items-center text-white text-xs w-full bg-colorDanger relative overflow-hidden story-overlay last:hidden"
      style={{
